            ...
            <table className="w-full min-w-[1780px] table-auto text-sm">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="w-14 px-1 py-2 text-center font-semibold text-gray-700 whitespace-nowrap" title="Show on catalog and sitemap (separate product card)">Catalog</th>
