...
/** Upload a collection presentation-set photo (table setup) to the dedicated R2 folder. */
export function uploadSalesCollectionScene(file) {
  return uploadAdminImage(file, SALES_COLLECTION_SCENE_FOLDER);
}
