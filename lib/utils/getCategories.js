...
export const getCategories = cache(async () => {
  // During build, only skip if DB isn't configured.
  // Skipping unconditionally causes empty categories in production HTML,
  // which then forces slow client-side category fetching on first load.
