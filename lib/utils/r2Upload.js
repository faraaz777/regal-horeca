 ...
 */
export async function uploadToR2(fileBuffer, originalFileName, folder = 'uploads', options = {}) {
  try {
    ...
    // Debug: Log what we're getting (without sensitive data) - only in development
    ...
    const command = new PutObjectCommand({
      ...
      // PDFs may be replaced; images are treated as immutable assets.
      CacheControl:
