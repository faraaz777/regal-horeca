 ...
 * Format: Country code + number (e.g., 917893960311 for India)
 * Defaults to 917893960311 if not set
 */
export function getWhatsAppBusinessNumber() {
  const number = process.env.NEXT_PUBLIC_WHATSAPP_BUSINESS_NUMBER || '917893960311';
