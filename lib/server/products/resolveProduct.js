 ...
 *       variationAttributes, visibleOnClient, sku, barcode, hsnCode, price,
...
/**
 * List a parent's children. PDP passes visibleOnly: false (all siblings on product page).
 * Catalog/sitemap use queryProducts + visibleOnClient instead.
 */
export async function getSiblingChildren(parentProductId, { visibleOnly = true } = {}) {
