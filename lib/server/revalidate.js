...
/**
 * Revalidate every relevant page when a parent or child product mutates.
 * Touches: storefront /products/<slug> for parent + each child slug, the sitemap,
 * and the products/facets caches. Pass an array of slugs (parent first, then
 * children) so callers don't have to refetch.
 */
export function revalidateProductSlugs(slugs = []) {
