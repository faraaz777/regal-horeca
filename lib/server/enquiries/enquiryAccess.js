...
export async function applyEnquiryUpdate({ enquiryId, session, body, request }) {
  ...
  /**
   * Only super_admin may reassign. Sales and data-entry can still
   * work status and notes, but cannot move ownership — that was
   * causing "who owns this?" fights on the floor.
   */
