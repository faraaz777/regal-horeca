...
import { buildProductSearchFilter } from '@/lib/server/products/productSearchFilter';
...
export async function queryProducts({
  ...
  const textSearchQuery = await buildProductSearchFilter(searchQuery);
  const useTextSearch = Boolean(textSearchQuery);
