    ...
    const built = buildChildPayloadFromVariantRow(
      {
        ...
        colorHex: body.variationAttributes?.colorHex ?? child.variationAttributes?.colorHex,
        colorSwatch: body.variationAttributes?.colorSwatch ?? child.variationAttributes?.colorSwatch,
        colorDetails: body.variationAttributes?.colorDetails ?? child.variationAttributes?.colorDetails,
